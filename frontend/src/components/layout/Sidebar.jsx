...
const NAV_CONFIG = [
  ...
  ] },
  {
    ...
    items: [
      ...
      { path: '/patients/en-attente', label: 'Patients en attente', icon: CheckCircleIcon, permission: 'readPatient', roles: ['doctor', 'doctor_chef', 'secretaire'] },
 ...
 
  {
    ...
    items: [
      { path: '/stats', label: 'Statistiques', icon: ChartIcon, roles: [ 'epidemiologist', 'readonly'] },
      { path: '/carte', label: 'Carte SIG', icon: MapIcon, roles: [ 'epidemiologist'] },
